        ...
        <div class="slide-bar" style="width: 20%;">
            ...
            <div class="categories">
                <div class="list-group">
                    ...
                    <a href="user.html " class="list-group-item list-group-item-action  "><svg
                    ...
                    <a href="product-admin.html" class="list-group-item list-group-item-action "
                    ...
                    <a href="categories.html" class="list-group-item list-group-item-action active"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
