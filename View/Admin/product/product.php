                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="margin-top: 10px;" href="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=destroy&product_id=<?= $item['product_id']?>"><button class="btn btn-primary" type="submit" style="margin-top: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
